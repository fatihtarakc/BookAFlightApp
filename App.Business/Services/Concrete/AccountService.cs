namespace App.Business.Services.Concrete
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<IdentityResult> AddAsync(IdentityUser identityUser, Role role)
        {
        ...
        public async Task<Role?> GetRoleAsync(IdentityUser identityUser) =>
            Enum.Parse<Role>((await userManager.GetRolesAsync(identityUser)).FirstOrDefault());
