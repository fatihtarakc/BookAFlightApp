namespace App.Cache.Services.Concrete
{
    public class CacheService<Entity> : ICacheService<Entity> where Entity : AuditableBaseEntity
    {
        ...
        public async Task<IResult> AddAsync(string cacheKey, Entity entity, TimeSpan expiration)
        {
            ...
            {
                logger.LogError($"{stringLocalizer[Messages.Redis_Cache_Entity_Could_Not_Be_Added]} : {exception.Message}");
        ...
        public async Task<IResult> DeleteAsync(string cacheKey)
        {
            ...
            {
                logger.LogError($"{stringLocalizer[Messages.Redis_Cache_Entity_Could_Not_Be_Deleted]} : {exception.Message}");
        ...
        public async Task<IDataResult<Entity>> GetByAsync(string cacheKey)
        {
            ...
            {
                logger.LogError($"{stringLocalizer[Messages.Redis_Cache_Entity_Was_Not_Found]} : {exception.Message}");
